...
if __name__ == '__main__':
    ...
    plt.subplot(121), plt.imshow(img_1_processed, cmap='gray')
    plt.title('Processed Image 1'), plt.xticks([]), plt.yticks([])
    plt.subplot(122), plt.imshow(img_2_processed, cmap='gray')
    plt.title('Processed Image 2'), plt.xticks([]), plt.yticks([])
    plt.show()
